...
INSERT INTO AD_Element (AD_Org_ID,AD_Element_ID,ColumnName,Created,CreatedBy,Description,EntityType,IsActive,Name,PrintName,Updated,AD_Client_ID,UpdatedBy) VALUES (0,53342,'DecimalPattern',TO_DATE('2008-02-11 19:27:36','YYYY-MM-DD HH24:MI:SS'),100,NULL,'U','Y','Decimal Pattern','Decimal Pattern',TO_DATE('2008-02-11 19:27:36','YYYY-MM-DD HH24:MI:SS'),0,100)
;
...
-- [FR1883270 ] Enhance Document No Formatting
UPDATE AD_Element SET Description=NULL,Updated=TO_DATE('2008-02-11 19:27:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53342
;
...
-- Feb 11, 2008 7:27:38 PM CET
-- [FR1883270 ] Enhance Document No Formatting
UPDATE AD_PrintFormatItem pi SET PrintName='Decimal Pattern', Name='Decimal Pattern' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=53342)
;
...
-- [FR1883270 ] Enhance Document No Formatting
UPDATE AD_Element SET Description='Java Decimal Pattern',Updated=TO_DATE('2008-02-11 19:27:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53342
;
...
-- [FR1883270 ] Enhance Document No Formatting
UPDATE AD_Element SET Help='Option Date pattern in Java notation. Examples: dd.MM.yyyy - dd/MM/yyyy If the pattern for your language is not correct, please create a Adempiere support request with the correct information',Updated=TO_DATE('2008-02-11 19:27:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=2673
;
...
-- Feb 11, 2008 7:27:53 PM CET
-- [FR1883270 ] Enhance Document No Formatting
UPDATE AD_PrintFormatItem pi SET PrintName='Date Pattern', Name='Date Pattern' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=2673)
;
...
-- [FR1883270 ] Enhance Document No Formatting
UPDATE AD_Element SET EntityType='D', Help='Option Decimal pattern in Java notation. Examples: 0000 will format 23 to 0023',Updated=TO_DATE('2008-02-11 19:29:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53342
;
...
-- [FR1883270 ] Enhance Document No Formatting
UPDATE AD_Column SET Name='DecimalPattern',Updated=TO_DATE('2008-02-11 19:30:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=54309
;
...
-- [FR1883270 ] Enhance Document No Formatting
UPDATE AD_Column SET Name='Decimal Pattern',Updated=TO_DATE('2008-02-11 19:30:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=54309
;
...
-- [FR1883270 ] Enhance Document No Formatting
UPDATE AD_Field SET DisplayLength=14,Updated=TO_DATE('2008-02-11 19:37:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=54391
;

-- Feb 11, 2008 7:37:28 PM CET
-- [FR1883270 ] Enhance Document No Formatting
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2008-02-11 19:37:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=54391
;
