...
UPDATE AD_Element SET PrintName='Product',Updated=TO_TIMESTAMP('2008-08-01 14:55:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53465
;
...
-- Aug 1, 2008 2:55:39 PM EST
-- Default comment for updating dictionary
UPDATE AD_PrintFormatItem SET PrintName='Product', Name='TM_Product_ID' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=53465)
;
