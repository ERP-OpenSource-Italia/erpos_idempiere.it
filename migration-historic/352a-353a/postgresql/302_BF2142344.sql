...
-- -
UPDATE AD_Column SET AD_Element_ID=1299, ColumnName='Classname', Description='Java Classname', FieldLength=255, Help='The Classname identifies the Java classname used by this report or process.', Name='Classname',Updated=TO_TIMESTAMP('2008-10-02 15:22:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=52068
;
