...
-- FR [ 2445409 ] Translate Info MRP
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,53718,0,'QtyScheduledRec',TO_TIMESTAMP('2008-12-18 16:50:30','YYYY-MM-DD HH24:MI:SS'),0,'EE01','Y','Scheduled Receipt Qty','Sched. Rec.',TO_TIMESTAMP('2008-12-18 16:50:30','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- FR [ 2445409 ] Translate Info MRP
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,53719,0,'QtyPlannedOrders',TO_TIMESTAMP('2008-12-18 16:54:33','YYYY-MM-DD HH24:MI:SS'),0,'EE01','Y','Planned Orders Qty','Planned Orders',TO_TIMESTAMP('2008-12-18 16:54:33','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- FR [ 2445409 ] Translate Info MRP
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,53720,0,'QtyProjOH',TO_TIMESTAMP('2008-12-18 16:56:45','YYYY-MM-DD HH24:MI:SS'),0,'EE01','Y','Projected On Hand Qty','Proj OH',TO_TIMESTAMP('2008-12-18 16:56:45','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- FR [ 2445409 ] Translate Info MRP
UPDATE AD_Element SET ColumnName='QtySchRcpt', PrintName='Sch. Rcpt.',Updated=TO_TIMESTAMP('2008-12-18 16:58:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53718
;
...
-- 18.12.2008 16:58:50 EET
-- FR [ 2445409 ] Translate Info MRP
UPDATE AD_PrintFormatItem SET PrintName='Sch. Rcpt.', Name='Scheduled Receipt Qty' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=53718)
;
