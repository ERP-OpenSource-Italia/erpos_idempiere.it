...
-- [ 2609604 ] Add M_RequisitionLine.C_BPartner_ID
INSERT INTO AD_Field (UpdatedBy,IsSameLine,IsHeading,CreatedBy,Updated,Description,DisplayLength,Help,IsFieldOnly,AD_Field_ID,AD_Tab_ID,AD_Column_ID,IsActive,Created,IsDisplayed,AD_Client_ID,AD_Org_ID,IsEncrypted,Name,IsReadOnly,IsCentrallyMaintained,EntityType) VALUES (0,'N','N',0,TO_DATE('2009-02-18 14:47:26','YYYY-MM-DD HH24:MI:SS'),'Identifies a Business Partner',10,'A Business Partner is anyone with whom you transact.  This can include Vendor, Customer, Employee or Salesperson','N',56715,642,56816,'Y',TO_DATE('2009-02-18 14:47:26','YYYY-MM-DD HH24:MI:SS'),'N',0,0,'N','Business Partner ','N','Y','U')
;
...
-- Feb 18, 2009 2:47:27 PM EET
-- [ 2609604 ] Add M_RequisitionLine.C_BPartner_ID
INSERT INTO AD_Field (UpdatedBy,IsSameLine,IsHeading,CreatedBy,Updated,Description,DisplayLength,Help,IsFieldOnly,AD_Field_ID,AD_Tab_ID,AD_Column_ID,IsActive,Created,IsDisplayed,AD_Client_ID,AD_Org_ID,IsEncrypted,Name,IsReadOnly,IsCentrallyMaintained,EntityType) VALUES (0,'N','N',0,TO_DATE('2009-02-18 14:47:27','YYYY-MM-DD HH24:MI:SS'),'Identifies a Business Partner',10,'A Business Partner is anyone with whom you transact.  This can include Vendor, Customer, Employee or Salesperson','N',56716,768,56816,'Y',TO_DATE('2009-02-18 14:47:27','YYYY-MM-DD HH24:MI:SS'),'N',0,0,'N','Business Partner ','N','Y','U')
;
...
-- [ 2609604 ] Add M_RequisitionLine.C_BPartner_ID
ALTER TABLE M_RequisitionLine ADD C_BPartner_ID NUMBER(10) DEFAULT NULL 
;
