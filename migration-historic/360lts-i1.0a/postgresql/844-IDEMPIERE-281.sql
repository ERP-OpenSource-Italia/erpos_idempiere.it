...
INSERT INTO AD_ImpFormat (Processing,AD_ImpFormat_ID,AD_Table_ID,FormatType,Description,Name,Updated,Created,CreatedBy,AD_Client_ID,UpdatedBy,IsActive,AD_Org_ID) VALUES ('N',200000,572,'C','Example Inventory for Garden World','Example Inventory',TO_TIMESTAMP('2012-05-28 22:41:17','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2012-05-28 22:41:17','YYYY-MM-DD HH24:MI:SS'),100,11,100,'Y',0)
;

-- May 28, 2012 10:49:35 PM COT
INSERT INTO AD_ImpFormat_Row (SeqNo,EndNo,DataType,AD_ImpFormat_Row_ID,StartNo,AD_Column_ID,DecimalPoint,DivideBy100,AD_ImpFormat_ID,Name,Updated,AD_Org_ID,Created,CreatedBy,IsActive,AD_Client_ID,UpdatedBy) VALUES (10,0,'S',200000,1,200187,'.','N',200000,'Document Type Name ',TO_TIMESTAMP('2012-05-28 22:49:34','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2012-05-28 22:49:34','YYYY-MM-DD HH24:MI:SS'),100,'Y',11,100)
;

-- May 28, 2012 10:51:35 PM COT
INSERT INTO AD_ImpFormat_Row (SeqNo,EndNo,DataType,AD_ImpFormat_Row_ID,StartNo,AD_Column_ID,DecimalPoint,DivideBy100,AD_ImpFormat_ID,Name,Updated,AD_Org_ID,Created,CreatedBy,IsActive,AD_Client_ID,UpdatedBy) VALUES (20,0,'S',200001,2,8826,'.','N',200000,'Line Description',TO_TIMESTAMP('2012-05-28 22:51:34','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2012-05-28 22:51:34','YYYY-MM-DD HH24:MI:SS'),100,'Y',11,100)
;

-- May 28, 2012 10:51:51 PM COT
INSERT INTO AD_ImpFormat_Row (SeqNo,EndNo,DataType,AD_ImpFormat_Row_ID,StartNo,AD_Column_ID,DecimalPoint,DivideBy100,AD_ImpFormat_ID,Name,Updated,AD_Org_ID,Created,CreatedBy,IsActive,AD_Client_ID,UpdatedBy) VALUES (30,0,'S',200002,3,8824,'.','N',200000,'Product Value',TO_TIMESTAMP('2012-05-28 22:51:50','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2012-05-28 22:51:50','YYYY-MM-DD HH24:MI:SS'),100,'Y',11,100)
;
...
INSERT INTO AD_ImpFormat_Row (SeqNo,EndNo,DataType,AD_ImpFormat_Row_ID,StartNo,AD_Column_ID,DecimalPoint,DivideBy100,AD_ImpFormat_ID,Name,Updated,AD_Org_ID,Created,CreatedBy,IsActive,AD_Client_ID,UpdatedBy) VALUES (50,0,'S',200004,5,200191,'.','N',200000,'Charge Name',TO_TIMESTAMP('2012-05-28 23:02:55','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2012-05-28 23:02:55','YYYY-MM-DD HH24:MI:SS'),100,'Y',11,100)
;

-- May 28, 2012 11:03:15 PM COT
INSERT INTO AD_ImpFormat_Row (SeqNo,EndNo,DataType,AD_ImpFormat_Row_ID,StartNo,AD_Column_ID,DecimalPoint,DivideBy100,AD_ImpFormat_ID,Name,Updated,AD_Org_ID,Created,CreatedBy,IsActive,AD_Client_ID,UpdatedBy) VALUES (60,0,'N',200005,0,8825,'.','N',200000,'Qty Book',TO_TIMESTAMP('2012-05-28 23:03:15','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2012-05-28 23:03:15','YYYY-MM-DD HH24:MI:SS'),100,'Y',11,100)
;

-- May 28, 2012 11:03:19 PM COT
UPDATE AD_ImpFormat_Row SET StartNo=6,Updated=TO_TIMESTAMP('2012-05-28 23:03:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ImpFormat_Row_ID=200005
;
...
INSERT INTO AD_ImpFormat_Row (SeqNo,EndNo,DataType,AD_ImpFormat_Row_ID,StartNo,AD_Column_ID,DecimalPoint,DivideBy100,AD_ImpFormat_ID,Name,Updated,AD_Org_ID,Created,CreatedBy,IsActive,AD_Client_ID,UpdatedBy) VALUES (80,0,'N',200007,8,200189,'.','N',200000,'Qty Internal Use',TO_TIMESTAMP('2012-05-28 23:03:47','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2012-05-28 23:03:47','YYYY-MM-DD HH24:MI:SS'),100,'Y',11,100)
;

-- May 28, 2012 11:39:52 PM COT
-- IDEMPIERE-281 Extend Import Inventory to support also internal use
UPDATE AD_Process_Para SET DefaultValue='@C_AcctSchema_ID@',Updated=TO_TIMESTAMP('2012-05-28 23:39:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=53375
;
