...
ALTER TABLE AD_Tree ADD IsLoadAllNodesImmediately CHAR(1) DEFAULT 'Y' CHECK (IsLoadAllNodesImmediately IN ('Y','N')) NOT NULL
;

-- Apr 3, 2017 5:19:18 PM CEST
ALTER TABLE AD_Tree MODIFY IsLoadAllNodesImmediately CHAR(1) DEFAULT 'Y'
;
