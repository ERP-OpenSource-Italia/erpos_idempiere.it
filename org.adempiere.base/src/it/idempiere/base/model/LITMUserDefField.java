...
public class LITMUserDefField
{
	...
	public static void setAD_SearchReference_ID(X_AD_UserDef_Field field,int AD_SearchReference_ID)
	{
	...
	public static void setAD_SearchVal_Rule_ID(X_AD_UserDef_Field field,int AD_SearchVal_Rule_ID)
	{
	...
	public static int getAD_SearchReference_ID(X_AD_UserDef_Field field)
	{
	...
	public static int getAD_SearchVal_Rule_ID(X_AD_UserDef_Field field)
	{
