...
implements DocAction
{
	...
	public String prepareIt()
	{
		...
		MAssetAcct assetAcct = MAssetAcct.forA_Asset_ID(getCtx(),getC_AcctSchema().getC_AcctSchema_ID(), getA_Asset_ID(), getPostingType(), getDateAcct(), get_TrxName());
		...
		{
		MAssetAcct acct = MAssetAcct.forA_Asset_ID(getCtx(),getC_AcctSchema().getC_AcctSchema_ID(), getA_Asset_ID(), getPostingType(), getDateAcct(), get_TrxName());
	...
	public String completeIt()
	{
		...
		MAssetAcct assetAcctPrev = MAssetAcct.forA_Asset_ID(getCtx(),getC_AcctSchema().getC_AcctSchema_ID(), getA_Asset_ID(), getPostingType(), getDateAcct(), get_TrxName());
