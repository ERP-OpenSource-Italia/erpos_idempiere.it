...
public class X_CM_AccessListRole extends PO implements I_CM_AccessListRole, I_Persistent 
{
    ...
    {
      StringBuilder sb = new StringBuilder ("X_CM_AccessListRole[")
	...
	/** Set CM_AccessListRole_UU.
		@param CM_AccessListRole_UU CM_AccessListRole_UU	  */
	public void setCM_AccessListRole_UU (String CM_AccessListRole_UU)
	{
		set_Value (COLUMNNAME_CM_AccessListRole_UU, CM_AccessListRole_UU);
	}

	/** Get CM_AccessListRole_UU.
		@return CM_AccessListRole_UU	  */
	public String getCM_AccessListRole_UU () 
	{
		return (String)get_Value(COLUMNNAME_CM_AccessListRole_UU);
	}
