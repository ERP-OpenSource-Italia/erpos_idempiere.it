...
public class X_CM_Ad_Cat extends PO implements I_CM_Ad_Cat, I_Persistent 
{
    ...
    {
      StringBuilder sb = new StringBuilder ("X_CM_Ad_Cat[")
	...
	/** Set CM_Ad_Cat_UU.
		@param CM_Ad_Cat_UU CM_Ad_Cat_UU	  */
	public void setCM_Ad_Cat_UU (String CM_Ad_Cat_UU)
	{
		set_Value (COLUMNNAME_CM_Ad_Cat_UU, CM_Ad_Cat_UU);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_CM_Ad_Cat_UU);
	}
