...
public class X_CM_BroadcastServer extends PO implements I_CM_BroadcastServer, I_Persistent 
{
    ...
    {
      StringBuilder sb = new StringBuilder ("X_CM_BroadcastServer[")
	...
	/** Set CM_BroadcastServer_UU.
		@param CM_BroadcastServer_UU CM_BroadcastServer_UU	  */
	public void setCM_BroadcastServer_UU (String CM_BroadcastServer_UU)
	{
		set_Value (COLUMNNAME_CM_BroadcastServer_UU, CM_BroadcastServer_UU);
	}

	/** Get CM_BroadcastServer_UU.
		@return CM_BroadcastServer_UU	  */
	public String getCM_BroadcastServer_UU () 
	{
		return (String)get_Value(COLUMNNAME_CM_BroadcastServer_UU);
	}
