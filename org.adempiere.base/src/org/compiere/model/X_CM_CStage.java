...
// Y
    ...
    {
      StringBuilder sb = new StringBuilder ("X_CM_CStage[")
	...
	public org.compiere.model.I_CM_CStage getCM_CStageLink() throws RuntimeException
    {
		return (org.compiere.model.I_CM_CStage)MTable.get(getCtx(), org.compiere.model.I_CM_CStage.Table_Name)
			.getPO(getCM_CStageLink_ID(), get_TrxName());	}
	...
	/** Set CM_CStage_UU.
		@param CM_CStage_UU CM_CStage_UU	  */
	public void setCM_CStage_UU (String CM_CStage_UU)
	{
		set_Value (COLUMNNAME_CM_CStage_UU, CM_CStage_UU);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_CM_CStage_UU);
	}
