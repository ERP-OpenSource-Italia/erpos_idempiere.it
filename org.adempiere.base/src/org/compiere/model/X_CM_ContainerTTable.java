...
public class X_CM_ContainerTTable extends PO implements I_CM_ContainerTTable, I_Persistent 
{
    ...
    {
      StringBuilder sb = new StringBuilder ("X_CM_ContainerTTable[")
	...
	/** Set CM_ContainerTTable_UU.
		@param CM_ContainerTTable_UU CM_ContainerTTable_UU	  */
	public void setCM_ContainerTTable_UU (String CM_ContainerTTable_UU)
	{
		set_Value (COLUMNNAME_CM_ContainerTTable_UU, CM_ContainerTTable_UU);
	}

	/** Get CM_ContainerTTable_UU.
		@return CM_ContainerTTable_UU	  */
	public String getCM_ContainerTTable_UU () 
	{
		return (String)get_Value(COLUMNNAME_CM_ContainerTTable_UU);
	}
