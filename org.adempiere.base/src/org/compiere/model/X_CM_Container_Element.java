...
public class X_CM_Container_Element extends PO implements I_CM_Container_Element, I_Persistent 
{
    ...
    {
      StringBuilder sb = new StringBuilder ("X_CM_Container_Element[")
	...
	/** Set CM_Container_Element_UU.
		@param CM_Container_Element_UU CM_Container_Element_UU	  */
	public void setCM_Container_Element_UU (String CM_Container_Element_UU)
	{
		set_Value (COLUMNNAME_CM_Container_Element_UU, CM_Container_Element_UU);
	}

	/** Get CM_Container_Element_UU.
		@return CM_Container_Element_UU	  */
