...
public class X_CM_Media extends PO implements I_CM_Media, I_Persistent 
{
    ...
    {
      StringBuilder sb = new StringBuilder ("X_CM_Media[")
	...
	/** Set CM_Media_UU.
		@param CM_Media_UU CM_Media_UU	  */
	public void setCM_Media_UU (String CM_Media_UU)
	{
		set_Value (COLUMNNAME_CM_Media_UU, CM_Media_UU);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_CM_Media_UU);
	}
