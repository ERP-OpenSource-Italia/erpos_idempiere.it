...
public class X_CM_NewsChannel extends PO implements I_CM_NewsChannel, I_Persistent 
{
    ...
    {
      StringBuilder sb = new StringBuilder ("X_CM_NewsChannel[")
	...
	/** Set CM_NewsChannel_UU.
		@param CM_NewsChannel_UU CM_NewsChannel_UU	  */
	public void setCM_NewsChannel_UU (String CM_NewsChannel_UU)
	{
		set_Value (COLUMNNAME_CM_NewsChannel_UU, CM_NewsChannel_UU);
	}

	/** Get CM_NewsChannel_UU.
		@return CM_NewsChannel_UU	  */
	public String getCM_NewsChannel_UU () 
	{
		return (String)get_Value(COLUMNNAME_CM_NewsChannel_UU);
	}
