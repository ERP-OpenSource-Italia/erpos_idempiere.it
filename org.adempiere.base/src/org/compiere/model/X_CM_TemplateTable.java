...
public class X_CM_TemplateTable extends PO implements I_CM_TemplateTable, I_Persistent 
{
    ...
    {
      StringBuilder sb = new StringBuilder ("X_CM_TemplateTable[")
	...
	/** Set CM_TemplateTable_UU.
		@param CM_TemplateTable_UU CM_TemplateTable_UU	  */
	public void setCM_TemplateTable_UU (String CM_TemplateTable_UU)
	{
		set_Value (COLUMNNAME_CM_TemplateTable_UU, CM_TemplateTable_UU);
	}

	/** Get CM_TemplateTable_UU.
		@return CM_TemplateTable_UU	  */
	public String getCM_TemplateTable_UU () 
	{
		return (String)get_Value(COLUMNNAME_CM_TemplateTable_UU);
	}
