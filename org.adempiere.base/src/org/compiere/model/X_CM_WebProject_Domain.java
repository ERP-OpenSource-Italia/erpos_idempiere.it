...
public class X_CM_WebProject_Domain extends PO implements I_CM_WebProject_Domain, I_Persistent 
{
    ...
    {
      StringBuilder sb = new StringBuilder ("X_CM_WebProject_Domain[")
	...
	/** Set CM_WebProject_Domain_UU.
		@param CM_WebProject_Domain_UU CM_WebProject_Domain_UU	  */
	public void setCM_WebProject_Domain_UU (String CM_WebProject_Domain_UU)
	{
		set_Value (COLUMNNAME_CM_WebProject_Domain_UU, CM_WebProject_Domain_UU);
	}

	/** Get CM_WebProject_Domain_UU.
		@return CM_WebProject_Domain_UU	  */
	public String getCM_WebProject_Domain_UU () 
	{
		return (String)get_Value(COLUMNNAME_CM_WebProject_Domain_UU);
	}
