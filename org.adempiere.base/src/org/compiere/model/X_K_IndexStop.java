...
// Y
    ...
    {
      StringBuilder sb = new StringBuilder ("X_K_IndexStop[")
	...
	/** Set K_IndexStop_UU.
		@param K_IndexStop_UU K_IndexStop_UU	  */
	public void setK_IndexStop_UU (String K_IndexStop_UU)
	{
		set_Value (COLUMNNAME_K_IndexStop_UU, K_IndexStop_UU);
	}

	/** Get K_IndexStop_UU.
		@return K_IndexStop_UU	  */
	public String getK_IndexStop_UU () 
	{
		return (String)get_Value(COLUMNNAME_K_IndexStop_UU);
	}
