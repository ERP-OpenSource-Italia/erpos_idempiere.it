...
// Y
    ...
    {
      StringBuilder sb = new StringBuilder ("X_K_Type[")
	...
	/** Set K_Type_UU.
		@param K_Type_UU K_Type_UU	  */
	public void setK_Type_UU (String K_Type_UU)
	{
		set_Value (COLUMNNAME_K_Type_UU, K_Type_UU);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_K_Type_UU);
	}
