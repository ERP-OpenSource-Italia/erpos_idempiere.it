...
public class SetupRes_fr extends ListResourceBundle
{
	...
	{ "AdempiereServerSetup", 	"Configuration du serveur iDempiere" },
	{ "Ok", 					"Ok" },
	{ "File", 					"Fichier" },
	{ "Exit", 					"Sortir" },
	{ "Help", 					"Aide" },
	{ "PleaseCheck", 			"Verifiez" },
	{ "UnableToConnect", 		"Impossible d'obtenir de l'aide depuis le site web iDempiere" },
	//
	{ "AdempiereHomeInfo", 		"R\u00E9pertoire racine d'iDempiere est le repertoire principale" },
	{ "AdempiereHome", 			"R\u00E9pertoire racine d'iDempiere" },
	...
	{ "DatabaseUserInfo", 		"ID de l'utilisateur de la base de donn\u00E9es iDempiere" },
	{ "DatabaseUser", 			"Utilisateur de la base de donn\u00E9es" },
	{ "DatabasePasswordInfo", 	"Mot de passe de la base de donn\u00E9es iDempiere" },
	...
	{ "AdminEMailInfo", 		"Courriel de l'administrateur iDempiere" },
	...
	{ "JNPPort", 				"Port JNP" },
	{ "MailUserInfo", 			"Utilisateur courriel iDempiere" },
	{ "MailUser", 				"Utilisateur courriel" },
	{ "MailPasswordInfo", 		"Mot de passe de l'utilisateur iDempiere" },
	...
	{ "ErrorAdempiereHome", 	"Erreur sur le r\u00E9pertoire iDempiere" },
