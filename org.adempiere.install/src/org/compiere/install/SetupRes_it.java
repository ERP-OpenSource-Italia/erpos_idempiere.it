...
public class SetupRes_it extends ListResourceBundle
{
	...
	{ "AdempiereServerSetup",	"Configurazione Server iDempiere" },
	{ "Ok", 					"Ok" },
	{ "File", 					"File" },
	{ "Exit", 					"Uscire" },
	{ "Help", 					"Help" },
	...
	//
	{ "AdempiereHomeInfo", 		"iDempiere Home:variabile di ambiente di iDempiere" },
	{ "AdempiereHome", 			"iDempiere Home" },
	{ "WebPortInfo", 			"Porta Web (HTML): Se esiste Apache server utilizzare la porta 8080 o 8088" },
	{ "WebPort", 				"Porta Web" },
	{ "AppsServerInfo", 		"Application Server: Nome dell'Host sul quale si installa iDempiere" },
	...
	{ "DatabaseUserInfo", 		"Utente del DataBase: Nome di creazione dello schema iDempiere" },
	{ "DatabaseUser", 			"Utente del DataBase" },
	{ "DatabasePasswordInfo", 	"Password del Database: dello schema iDempiere" },
	...
	{ "AdminEMailInfo", 		"Email Amministratore iDempiere" },
	...
	{ "ErrorAdempiereHome", 	"Errore iDempiere Home" },
	{ "ErrorAppsServer", 		"Errore Servidor Aplicaci\u00f3n" },
	{ "ErrorWebPort", 			"Errore Porta Web: potrebbe essere occupata dall'apache server o dal server iDempiere utilizzare 8080" },
	{ "ErrorJNPPort", 			"Errore Porta JNP potrebbe essere occupata da un'altra istanza del server iDempiere" },
