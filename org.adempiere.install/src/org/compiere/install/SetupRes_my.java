...
public class SetupRes_my extends ListResourceBundle
{
	...
	{ "UnableToConnect",	"Tidak mendapat bantuan dari laman projek iDempiere" },

	{ "AdempiereHomeInfo", 	"iDempiere Home adalah folder utama" },
	{ "AdempiereHome", 		"iDempiere Home" },
	{ "WebPortInfo", 		"Web (HTML) Port" },
	{ "WebPort", 			"Web Port" },
	{ "AppsServerInfo", 	"Nama Pelayan iDempiere" },
	...
	{ "DatabaseUserInfo", 	"Database iDempiere ID Pengguna Database iDempiere" },
	...
	{ "AdminEMailInfo", 	"Emel Pentadbiran iDempiere" },
	...
	{ "JNPPort", 			"JNP Port" },
	{ "MailUserInfo", 		"Pengguna Emel iDempiere" },
	{ "MailUser", 			"Pengguna Emel" },
	{ "MailPasswordInfo", 	"Kata-Laluan Pengguna Emel iDempiere" },
