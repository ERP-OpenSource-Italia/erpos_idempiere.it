...
//		new Info_Column(Msg.translate(Env.getCtx(), "SO_CreditUsed"), "C_BPartner.SO_CreditUsed", BigDecimal.class),
		new Info_Column(Msg.translate(Env.getCtx(), "SO_CreditAvailable"), "C_BPartner.SO_CreditLimit-LS_calcSOCreditUsed(C_BPartner.C_BPartner_ID, C_BPartner.AD_Client_ID, C_BPartner.AD_Org_ID) AS SO_CreditAvailable", BigDecimal.class, true, true, null),
		new Info_Column(Msg.translate(Env.getCtx(), "SO_CreditUsed"), "LS_calcSOCreditUsed(C_BPartner.C_BPartner_ID, C_BPartner.AD_Client_ID, C_BPartner.AD_Org_ID) AS SO_CreditUsed", BigDecimal.class),
