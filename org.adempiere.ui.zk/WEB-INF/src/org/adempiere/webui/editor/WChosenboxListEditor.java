...
public class WChosenboxListEditor extends WEditor implements ContextMenuListener
{
	 ...
	 * @param gridField
	 */
	public WChosenboxListEditor(GridField gridField,boolean tableEditor)
	{
        this(new ChosenSearchBox(new ChosenboxEditor()), gridField,tableEditor);
    }
    
    private WChosenboxListEditor(Component comp, GridField gridField,boolean tableEditor)
    {
