 ...
 */
public class CreateRecordAuto extends TableFixture {
	...
	private boolean doOriginalLoop(Properties ctx, int windowNo,
			String trxName, PO gpo, String columnName, boolean columnsOK,
			boolean isErrorExpected, String msgerror1, MTable table,
			POInfo poinfo, int i, String cell_title, String cell_value,
			int idxcol) {
		if (idxcol < 0) {
			wrong(i,0);
